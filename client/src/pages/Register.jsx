    ...
    <div className="min-h-[calc(100vh-60px)] bg-[var(--bg)] flex items-center justify-center px-6 py-12">
      ...
      <div className="relative z-10 card max-w-md w-full p-10 animate-up">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-[24px] mono font-bold text-[var(--text)] mb-2">Join DevLog</h1>
          <p className="text-[14px] text-[var(--text2)]">Create your free developer account</p>
        </div>
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <span className="text-[12px] text-[var(--text3)]">or sign up with email</span>
          <div className="flex-1 h-px bg-[var(--border)]"></div>
        </div>
          ...
          <div>
            ...
            {passwordStrength && (
              <div className="mt-2">
                ...
                <p className="text-[12px] mt-1" style={{ color: passwordStrength.color }}>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`w-full bg-[var(--bg3)] border rounded-lg px-4 py-3 pr-12 text-[14px] text-[var(--text)] outline-none focus:ring-4 transition ${
                  formData.confirmPassword && !passwordsMatch
                    ? 'border-[var(--red)] focus:border-[var(--red)] focus:ring-[rgba(248,81,73,0.1)]'
                    : 'border-[var(--border)] focus:border-[var(--accent)] focus:ring-[var(--accent-glow2)]'
                }`}
                required
              />
              <button
            ...
            {formData.confirmPassword && !passwordsMatch && (
              <p className="text-[12px] text-[var(--red)] mt-1">Passwords don't match</p>
            )}
          </div>
